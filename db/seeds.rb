...
['juan', 'andrea', 'leon', 'andres', 'natalia', 'camilo', 'rusbel', 'john'].each do |name|
  User.create email: "#{name}@example.com", password: 'soydeventrar'
end
...
owner = User.find_by(email: 'john@example.com')
